...
) ENGINE=InnoDB AUTO_INCREMENT=21604 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=5784 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=590264 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=63034 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_greetings` (
  ...
  `player_id` int(11) NOT NULL,
  `greeting_type` int(11) NOT NULL DEFAULT '0',
...
-- Dump completed on 2023-11-25 22:03:29
